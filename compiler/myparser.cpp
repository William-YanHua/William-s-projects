	...
	case 7:
		{
			...
			{
#line 89 ".\\myparser.y"
 (*(YYSTYPE YYFAR*)yyvalptr).dval = yyattribute(2 - 2).dval - 1; 
	...
	case 9:
		{
			...
			{
#line 91 ".\\myparser.y"
 (*(YYSTYPE YYFAR*)yyvalptr).dval = pow(yyattribute(1 - 3).dval,yyattribute(3 - 3).dval); 
	...
	case 11:
		{
			...
			{
#line 93 ".\\myparser.y"
 (*(YYSTYPE YYFAR*)yyvalptr).dval = yyattribute(1 - 1).dval; 
...
void YYPARSERNAME::yytables()
{
	...
	static const yystateaction_t YYNEARFAR YYBASED_CODE stateaction[] = {
		...
		{ -271, 1, YYAT_ERROR, 0 },
		{ -267, 1, YYAT_REDUCE, 6 },
		{ -244, 1, YYAT_REDUCE, 10 },
		{ -246, 1, YYAT_REDUCE, 12 },
		{ -249, 1, YYAT_REDUCE, 11 },
		{ -266, 1, YYAT_ERROR, 0 },
		{ 0, 0, YYAT_REDUCE, 1 },
		{ 0, 0, YYAT_DEFAULT, 20 },
		{ 0, 0, YYAT_DEFAULT, 20 },
		...
		{ -255, 1, YYAT_REDUCE, 7 },
		{ -260, 1, YYAT_REDUCE, 8 },
		{ -264, 1, YYAT_REDUCE, 13 }
	};
	yystateaction = stateaction;

	yynontermgoto_size = 12;
